...
public class Tank {
    ...
    public void move(ArrayList<Map> maps) {
        ...
        if (!check) {
            ...
            y = 0;
        } else if (x > CustomFrame.W_FRAME - images[orient].getWidth(null) - 5) {
            x = CustomFrame.W_FRAME - images[orient].getWidth(null) - 5;
        } else if (y > CustomFrame.H_FRAME - images[orient].getHeight(null) - 30) {
            y = CustomFrame.H_FRAME - images[orient].getHeight(null) - 30;
        }
    }
    ...
    public boolean checkMoveBot(ArrayList<Map> maps) {
        int xRaw = x;
        int yRaw = y;
        switch (orient) {
            case LEFT:
